  ...
  return (
    <div className="flex flex-col ml-[120px]">
      ...
      <div className="w-[400px] h-[450px]"></div>
        <h2 id="pr" className="text-5xl font-bold">Projects</h2>
      ...
      <div className="grid items-center grid-cols-2 gap-6 font-inter">
        ...
        <div className="w-[400px] h-[450px] bg-[#1e293b]  text-3xl font-bold">
          <div className="max-w-sm pt-[30px] overflow-hidden rounded ">
            ...
            <div className="px-6 py-2">
              <div className="mb-2 text-xl font-bold">
              Superchat Web Socket and Cloud App
              </div>
              <p className="text-base text-gray-700">
              Chatroom Application using Google Auth and database provided by Firebase BAAS.Supports Mobile and desktop view
              </p>
            </div>
